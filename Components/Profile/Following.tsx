...
const wrapFollowing = (
  ...
  return (
    <>
      <Tr key={followee.name + "FollowingProfileSection"}>
        <Td>{followee.name}</Td>
        <Td><Center>{followee.uploads.length}</Center></Td>
        <Td><Center>{followee.followers.length}</Center></Td>
        <Td><Center>{followee.following.length}</Center></Td>
        <Td>
          <Center>
            {followsBack ? (
